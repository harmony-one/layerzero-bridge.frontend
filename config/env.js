  ...
  const raw = Object.keys(process.env)
    ...
    .reduce(
      ...
      },
      {
        ...
        METAMASK_BSC_CHAIN_NAME: process.env.METAMASK_BSC_CHAIN_NAME,
        METAMASK_BSC_RPC_URL: process.env.METAMASK_BSC_RPC_URL,
        METAMASK_BSC_EXPLORER: process.env.METAMASK_BSC_EXPLORER,
        METAMASK_BSC_CHAIN_ID: process.env.METAMASK_BSC_CHAIN_ID,

        METAMASK_ARB_CHAIN_NAME: process.env.METAMASK_ARB_CHAIN_NAME,
        METAMASK_ARB_RPC_URL: process.env.METAMASK_ARB_RPC_URL,
        METAMASK_ARB_EXPLORER: process.env.METAMASK_ARB_EXPLORER,
        METAMASK_ARB_CHAIN_ID: process.env.METAMASK_ARB_CHAIN_ID,
        
        METAMASK_HMY_CHAIN_ID: process.env.METAMASK_HMY_CHAIN_ID,
        METAMASK_HMY_CHAIN_NAME: process.env.METAMASK_HMY_CHAIN_NAME,
        METAMASK_HMY_RPC_URL: process.env.METAMASK_HMY_RPC_URL,
        METAMASK_HMY_EXPLORER: process.env.METAMASK_HMY_EXPLORER,
        
        METAMASK_ETH_CHAIN_NAME: process.env.METAMASK_ETH_CHAIN_NAME,
        METAMASK_ETH_RPC_URL: process.env.METAMASK_ETH_RPC_URL,
        METAMASK_ETH_EXPLORER: process.env.METAMASK_ETH_EXPLORER,
        METAMASK_ETH_CHAIN_ID: process.env.METAMASK_ETH_CHAIN_ID,
        ...
        HMY_HRC721_MANAGER_CONTRACT: process.env.HMY_HRC721_MANAGER_CONTRACT,
        HMY_HRC1155_MANAGER_CONTRACT: process.env.HMY_HRC1155_MANAGER_CONTRACT,
        HMY_ERC1155_MANAGER_CONTRACT: process.env.HMY_ERC1155_MANAGER_CONTRACT,
        HMY_ERC1155_MANAGER_TOKEN: process.env.HMY_ERC1155_MANAGER_TOKEN,
        ...
        TOKEN_MANAGER_CONTRACT_FOR_BSC:
          process.env.TOKEN_MANAGER_CONTRACT_FOR_BSC,
        TOKEN_MANAGER_CONTRACT: process.env.TOKEN_MANAGER_CONTRACT,

        HMY_ERC20_SUB_MANAGER_CONTRACT:
          process.env.HMY_ERC20_SUB_MANAGER_CONTRACT,
        HMY_BEP20_SUB_MANAGER_CONTRACT:
