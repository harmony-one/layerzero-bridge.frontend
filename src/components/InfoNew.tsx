  ...
  <Box className={styles.infoContainer} pad="large">
    ...
    <div>
      <Text style={{ lineHeight: '22px' }}>
        <p>
          The LayerZero-Harmony Bridge Interface (“Interface”) is an interface
          that facilitates use of a third-party cross-chain communication system
          (“Bridge”) that is designed to enable users to send messages between
          certain blockchains to enable the exchange of crypto assets between
          such blockchains. Your use of the Interface and the Bridge is entirely
          at your own risk.
        </p>
        <p>
          The Interface and the Bridge are available on an “as is” basis without
          warranties of any kind, either express or implied, including, but not
          limited to, warranties of merchantability, title, fitness for a
          particular purpose and non-infringement.
        </p>
        <p>
          You assume all risks associated with using the Interface and the
          Bridge, and digital assets and decentralized systems generally,
          ...
          use of the Interface or the Bridge. For example, these losses may
        ...
        <p>
          The Interface and the Bridge do not collect any personal data, and
          your interaction with the Interface and the Bridge will solely be
          through your public digital wallet address. Any personal or other data
          that you may make available in connection with the Bridge may not be
          private or secure.
        </p>
      </Text>
    </div>
